...
-- tblInsa. 기획부 몇명? 총무부 몇명? 개발부 몇명? 나머지 부서 몇명? > 1개의 테이블
select
    count(case
...
-- 컬럼 리스트에서는 집계합수와 일반컬럼을 동시에 사용할 수 없다.

--요구사항] 직원들 이름과 총지원수를 가져오시오.
